//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (32989c17) on 2020-12-08 18:00:30
//--------------------------------------------------------------------------------
module nexys4ddr(
...
reg [14:0] basesoc_mem_px_addr_storage = 15'd0;
reg basesoc_mem_px_addr_re = 1'd0;
wire [7:0] basesoc_mem_px_data_status;
wire basesoc_mem_px_data_we;
wire basesoc_mem_px_data_re;
wire basesoc_irq;
...
assign basesoc_eventmanager_status_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign basesoc_eventmanager_status_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign basesoc_eventmanager_pending_r = builder_interface1_bank_bus_dat_w[0];
assign basesoc_eventmanager_pending_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
assign basesoc_eventmanager_pending_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
...
assign builder_csrbank1_mem_px_addr0_w = basesoc_mem_px_addr_storage[14:0];
assign builder_csrbank1_mem_px_data_w = basesoc_mem_px_data_status[7:0];
assign basesoc_mem_px_data_we = builder_csrbank1_mem_px_data_we;
assign basesoc_mem_px_data_re = builder_csrbank1_mem_px_data_re;
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank1_mem_px_addr0_re) begin
		basesoc_mem_px_addr_storage[14:0] <= builder_csrbank1_mem_px_addr0_r;
	end
	basesoc_mem_px_addr_re <= builder_csrbank1_mem_px_addr0_re;
	...
	if (sys_rst) begin
		...
		basesoc_mem_px_addr_storage <= 15'd0;
		basesoc_mem_px_addr_re <= 1'd0;
		basesoc_ok_pending <= 1'd0;
...
camara camara(
	...
	.CAM_vsync(cam_vsync),
	.clk(sys_clk),
	.mem_px_addr(basesoc_mem_px_addr_storage),
	.rst(sys_rst),
	.CAM_pwdn(cam_pwdn),
	.CAM_xclk(cam_xclk),
	...
	.mem_px_data(basesoc_mem_px_data_status)
);
